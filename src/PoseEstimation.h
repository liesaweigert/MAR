...
*/
void estimateSquarePose_(Eigen::Matrix4f& result, CvPoint2D32f* p2D, float markerSize);
void estimateSquarePose(Eigen::Matrix4f& result, const cv::Point2f* p2D_, float markerSize);
...
*/
void calcHomography(float* result, const CvPoint2D32f* pQuad);